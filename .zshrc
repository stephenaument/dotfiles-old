...
export PATH=/Users/saument/bin:/opt/local/bin:/opt/local/sbin:/usr/local/bin:/usr/local/sbin/:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/opt/X11/bin/opt/local/bin:/opt/local/sbin:/usr/local/share/python:/usr/local/pgsql/bin:/usr/local/sbin:/usr/local/mysql/bin:/Users/saument/ec2-api-tools-1.3-30349/bin:/Developer/usr/bin
